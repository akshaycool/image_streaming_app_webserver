...
app.get('/',function(req,res){
    res.sendfile('./public/index.html');//to serve the html file when someone hits the index route.
})
...
subSocket.on('message',function(message){
    io.sockets.emit('badge',message); //sends the badge with the message to everyone connected to this socket.
});